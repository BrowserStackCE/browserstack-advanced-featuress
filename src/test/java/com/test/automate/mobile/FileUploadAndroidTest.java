...
public class FileUploadAndroidTest extends WebBaseTest {

    @Test
    public void fileUpload() {
        String sessionId = ((RemoteWebDriver) driver).getSessionId().toString();
        AppUtils.pushFile(sessionId, "src/test/resources/app/data/turtlerock.jpg", "/sdcard/Download/turtlerock.jpg");
